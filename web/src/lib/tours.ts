...
export const TOURS: Record<'explore' | 'species' | 'tree', Record<Locale, Step[]>> = {
  explore: {
    en: [
      ...
      { target: '#years', title: 'Time', body: 'Drag across decades, or press <b>Play</b> to watch Peru’s known flora grow since Linnaeus (1753). One species in five was described after 2000.', placement: 'top' },
    ...
    es: [
      ...
      { target: '#years', title: 'El tiempo', body: 'Arrastra sobre las décadas, o pulsa <b>Reproducir</b> para ver crecer la flora conocida del Perú desde Linneo (1753). Una de cada cinco especies se describió después del 2000.', placement: 'top' },
  ...
  tree: {
    en: [
      ...
      { target: '#phylo-plantae-chart', title: 'Each dot is a group', body: 'The centre is the kingdom; the spokes are <b>orders</b>. Dot size is the number of species and colour the clade.', placement: 'right' },
    ...
    es: [
      ...
      { target: '#phylo-plantae-chart', title: 'Cada punto es un grupo', body: 'El centro es el reino; los radios son <b>órdenes</b>. El tamaño del punto es el número de especies y el color, el clado.', placement: 'right' },
