...
const enBase = {
  ...
  'tree.lede': 'How the species recorded in Peru split across clades (APG IV for flowering plants, PPG I for lycophytes and ferns), orders and families. Pick a group, in the tree or in the list, to see where it lives, then open it in the explorer.',
  'tree.linear': 'Linear',
  'tree.reset': 'Reset',
...
const esBase: Record<keyof typeof enBase, string> = {
  ...
  'tree.lede': 'Cómo se reparten las especies registradas en el Perú entre clados (APG IV para plantas con flor, PPG I para licófitos y helechos), órdenes y familias. Elige un grupo, en el árbol o en la lista, para ver dónde vive, y ábrelo en el explorador.',
  'tree.linear': 'Lineal',
