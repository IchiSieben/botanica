...
const en = {
  ...
  'year.note': 'Year of first publication of the accepted name (WCVP). Drag across decades to select a range.',
  'year.play': 'Play',
  'year.stop': 'Stop',
...
const es: Record<Key, string> = {
  ...
  'year.note': 'Año de primera publicación del nombre aceptado (WCVP). Arrastra sobre las décadas para elegir un rango.',
